...
class PinwheelNetwork:
  def __init__(self, config = CommonConfig()):
    ...
    config.tau_rise_noisy_exc_gaba1 = config.fetch("tau_rise_noisy_exc_gaba1", 0.0)
    config.tau_damp_noisy_exc_gaba1 = config.fetch("tau_damp_noisy_exc_gaba1", 0.0)
    ...
    config.tau_rise_noisy_exc_gaba2 = config.fetch("tau_rise_noisy_exc_gaba2", 0.0)
    config.tau_damp_noisy_exc_gaba2 = config.fetch("tau_damp_noisy_exc_gaba2", 0.0)
