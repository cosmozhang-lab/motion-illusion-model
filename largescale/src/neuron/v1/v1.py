...
class V1DirectNeuronGroup (NeuronGroup):
  ...
  def __init__(self, config=CommonConfig()):
    ...
    self.amp_noisy_exc_nmda = config.fetch("amp_noisy_exc_nmda", 1.0)
    ...
    self.amp_noisy_exc_ampa = config.fetch("amp_noisy_exc_ampa", 1.0)
    ...
    self.amp_noisy_exc_gaba1 = config.fetch("amp_noisy_exc_gaba1", 1.0)
    ...
    self.amp_noisy_exc_gaba2 = config.fetch("amp_noisy_exc_gaba2", 1.0)
    ...
    self.amp_noisy_inh_nmda = config.fetch("amp_noisy_inh_nmda", 1.0)
    ...
    self.amp_noisy_inh_ampa = config.fetch("amp_noisy_inh_ampa", 1.0)
    ...
    self.amp_noisy_inh_gaba1 = config.fetch("amp_noisy_inh_gaba1", 1.0)
    ...
    self.amp_noisy_inh_gaba2 = config.fetch("amp_noisy_inh_gaba2", 1.0)
    ...
    self.amp_lgn_on_pos = config.fetch("amp_lgn_on_pos", 1.0)
    ...
    self.amp_lgn_on_neg = config.fetch("amp_lgn_on_neg", 1.0)
    ...
    self.amp_lgn_off_pos = config.fetch("amp_lgn_off_pos", 1.0)
    ...
    self.amp_lgn_off_neg = config.fetch("amp_lgn_off_neg", 1.0)
    ...
    self.lgn_on_pos = DirectConnection(tau_rise = self.tau_rise_lgn_on_pos, tau_damp = self.tau_damp_lgn_on_pos, shape = self.shape, stimulus = self.stimulus, kernels = self.lgn_kernels_on, ikernels = self.lgn_ikernels_on, amp = self.amp_lgn_on_pos)
    self.lgn_on_neg = DirectConnection(tau_rise = self.tau_rise_lgn_on_neg, tau_damp = self.tau_damp_lgn_on_neg, shape = self.shape, stimulus = self.stimulus, kernels = self.lgn_kernels_on, ikernels = self.lgn_ikernels_on, amp = self.amp_lgn_on_neg)
    self.lgn_off_pos = DirectConnection(tau_rise = self.tau_rise_lgn_off_pos, tau_damp = self.tau_damp_lgn_off_pos, shape = self.shape, stimulus = self.stimulus, kernels = self.lgn_kernels_off, ikernels = self.lgn_ikernels_off, amp = self.amp_lgn_off_pos)
    self.lgn_off_neg = DirectConnection(tau_rise = self.tau_rise_lgn_off_neg, tau_damp = self.tau_damp_lgn_off_neg, shape = self.shape, stimulus = self.stimulus, kernels = self.lgn_kernels_off, ikernels = self.lgn_ikernels_off, amp = self.amp_lgn_off_neg)
