__kernel void rk2params(
  __global const float *g_lgn_on_pos,
  __global const float *g_lgn_on_neg,
  __global const float *g_lgn_off_pos,
  __global const float *g_lgn_off_neg,
  ...
  float g_lgn_on = g_lgn_on_pos[i] - g_lgn_on_neg[i];
  float g_lgn_off = g_lgn_off_pos[i] - g_lgn_off_neg[i];
  float g_lgn = g_lgn_on + g_lgn_off;
